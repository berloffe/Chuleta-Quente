...
if($_POST) { // se o usuário clicou no botao refresh
    if ($_FILES['imagemfile']['name']) { // se o usuário escolher uma imagem
        unlink("../images/".$_POST['imagem_atual']); // apaga a imagem atual do server de arquivos
        $nome_img = $_FILES['imagemfile']['name'];
        $tmp_img = $_FILES['imagemfile']['tmp_name'];
        $rand = rand(100001,999999); // gera um número aleátorio para imagems salva para diferenciar as imagens uma das outras
        ...
        <div class="col-xs-12 col-sm-offset-2 col-sm-6  col-md-8">
            ...
            <div class="thumbnail">
                <div class="alert alert-danger" role="alert">
                    ...
                    id="form_insere">
                     <!-- campo id deve permanecer oculpor por isso "hidden" -->
