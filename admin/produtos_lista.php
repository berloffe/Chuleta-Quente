<?php
 ...
 $row = $lista->fetch_assoc(); //retornar uma matriz (array) que se determina falso ele para se ainda tiver linha ele continua mostrando
 $rows = $lista->num_rows;
                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                                ...
                                } else {echo '<span class="glyphicon glyphicon-ok text-success" aria-hidden="true"></span>';}
                                echo '&nbsp;';
                                echo $row['descricao'];
                            ?>
                        </td>
                        ...
                        <td>
                            ...
                            >
                                ...
                                <span class="hidden-xs">Alterar</span>
                                    ...
                                    <!-- GRAÇOLINHA - não mostrar o botão excluir se o produto estiver em destaque -->
                                    <?php  
                            ...
                            <button
                                ...
                                class="delete btn-xs btn-block btn-danger
